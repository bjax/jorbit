...
public class StateVectorTest {
    ...
    /**
     * Test of length method, of class StateVector.
     */
    @Test
    ...
    /**
     * Test of set and get methods, of class StateVector.
     */
    @Test
    ...
    /**
     * Test of scale method, of class StateVector.
     */
    @Test
    ...
    public void testCopy() {
        StateVector copy = new StateVector(instance);
    ...
    /**
     * Test of plus method, of class StateVector.
     */
    @Test
    public void testPlus() {
        StateVector dup = new StateVector(instance);
        dup.scale(2.0);
    ...
    /**
     * Test of mult method, of class StateVector.
     */
    @Test
    public void testMult() {
        Double factor = 2.0;
        StateVector expResult = null;
        StateVector result = StateVector.mult(instance, factor);
    ...
    /**
     * Test of add method, of class StateVector.
     */
    @Test
    public void testAdd() {
        StateVector dup = new StateVector(instance);
        StateVector result = StateVector.add(instance, dup);
        assertEquals(0.0, result.get(0), eps);
        assertEquals(2.0, result.get(1), eps);
        assertEquals(4.0, result.get(2), eps);
    }
