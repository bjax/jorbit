 ...
 * @author ebjackso
 */
public class SystemVectorTest {
    SystemVector instance;
    double eps = 1e-14;

    public SystemVectorTest() {
    }
    ...
    /**
     * Test of length method, of class SystemVector.
     */
    @Test
    ...
    /**
     * Test of set and get methods, of class SystemVector.
     */
    @Test
    ...
    /**
     * Test of scale method, of class SystemVector.
     */
    @Test
    ...
    public void testCopy() {
        SystemVector copy = new SystemVector(instance);
    ...
    /**
     * Test of plus method, of class SystemVector.
     */
    @Test
    public void testPlus() {
        SystemVector dup = new SystemVector(instance);
        dup.scale(2.0);
    ...
    /**
     * Test of mult method, of class SystemVector.
     */
    @Test
    public void testMult() {
        Double factor = 2.0;
        SystemVector expResult = null;
        SystemVector result = SystemVector.mult(instance, factor);
    ...
    /**
     * Test of add method, of class SystemVector.
     */
    @Test
    public void testAdd() {
        SystemVector dup = new SystemVector(instance);
        SystemVector result = SystemVector.add(instance, dup);
        assertEquals(0.0, result.get(0), eps);
        assertEquals(2.0, result.get(1), eps);
        assertEquals(4.0, result.get(2), eps);
    }
